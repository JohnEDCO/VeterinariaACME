...
if($_SESSION['idRol'] == 9){
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="adm_catalogo.php">
                <img src="../Img/logoAcme.jpg" alt="" class="sidebar-brand-icon icon-circle">
                <div class="sidebar-brand-text mx-3">ACME<br><?php echo $_SESSION['tipoRol'] ?> </br></div>
            </a>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Si esta seguro presione el boto cerrar sesion.</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                    <a class="btn btn-primary" href="../Controllers/Logout.php">Cerrar sesion</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../Js/jquery.min.js"></script> //Jquery.min
