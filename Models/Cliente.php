...
include_once "Conexion.php";
 class Cliente{
    ...
    function registrar_cliente($nombre, $apellido, $telefono, $email, $direccion, $tipoDoc, $documento){
        ...
        $sql = "INSERT INTO cliente (nombreCliente, apellidoCliente, telefono, email, direccion, tipoDocumento, numeroDocumento) VALUES(:nombre, :apellido, :telefono, :email, :direccion, :tipoDoc, :documento)";
    ...
    function obtener_clientes(){
        ...
        if(!empty($_POST['dato'])) {
            $dato = $_POST['dato'];
            $sql = "Select * from cliente where nombreCliente like :dato or numeroDocumento like :dato";
            $query = $this->acceso->prepare($sql);
    ...
    function editar_cliente($id,$documento, $tipoDoc, $nombre, $apellido, $telefono, $email,$direccion ){
        ...
        $sql = "UPDATE cliente SET nombreCliente=:nombre, apellidoCliente=:apellido, telefono=:telefono, email=:email, direccion=:direccion, tipoDocumento=:tipoDoc, numeroDocumento=:documento WHERE idCliente=:id";
        $query = $this->acceso->prepare($sql);
